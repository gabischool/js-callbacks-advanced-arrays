...
runners.map(element => {
    // console.log(element.first_name.toUpperCase());
...
//  console.log(element.shirt_size );
 ...
 largeShirts.push(element.shirt_size)
  console.log(element.shirt_size);
...
// get all the emails for the runners
...
//  log all campanies names.

let campanies = [];

runners.forEach( item => {

campanies.push(item.company_name);
